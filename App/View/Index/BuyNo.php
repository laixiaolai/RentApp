...
<body>
		    		...
		    		<div class='col-xs-12' style="background: white;padding-top: 46px;padding-bottom: 32px;">
		    			<div class='text-center' style="margin-bottom:40px;">
		    				...
		    				<div style="margin-top:24px;margin-bottom:10px;" class="font-size-14">
		    					<span class='rgb225' style="font-size: 20px;">对不起支付失败！</span>
		    				</div>
		    			...
		    			<div class="row">
		    				<div class='col-sm-6'>
		    					<div id="fanhui" style="background-color: rgb(225, 112, 114);color:white;padding:16px 16%;" class="comment-more font-size-20" >
		    						返回首页
		    					</div>
		    				</div>
		    			</div>
	...
	$(function(){
		$("#fanhui").click(function(event) {
			location.href = '<?php echo $host_url; ?>';
		});
	});
	</script>
</body>
