...
<body class='home'>
    ...
    <div class='image-area'>
        ...
        <div class='title-text visible-xs'>
            <h1 style="margin-bottom:0;font-size:54px;">游在异乡</h1>
            <h1 style="margin-bottom:0;font-size:54px;">吃在我家</h1>
    ...
    <div class='content'>
        <div class='container'>
            ...
            <div class='row'>
                ...
                <a class='col-xs-12 col-sm-6' href="./index.php?a=List&label=台湾">
                ...
                <a class='col-xs-12 col-sm-6' href="./index.php?a=List&label=首尔">
                ...
                <a class='col-xs-12 col-sm-6' href="./index.php?a=List&label=东京">
