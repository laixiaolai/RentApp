	    						...
	    						<div>
	    							...
	    							<div class='col-xs-12  step-article'>
	    								<div class='step3-content'>
	    									...
	    									<input type="text" class='col-xs-9' placeholder="xiaoming" v-model="info_xm" style="padding: 15px 30px;line-height: 14px;display:block;">
	    								</div>
	    								...
	    								<div class='step3-content'>
	    									...
	    									<input type="text" class='col-xs-9' placeholder="13000000000" v-model="info_dh" style="padding: 15px 30px;line-height: 14px;display:block;">
	    								</div>
	    								<div class='step3-content'>
